...
std::vector<AboutPanel::Section> AboutPanel::makeSections (bool english)
{
    ...
    if (english)
    {
        ...
        s.push_back ({ utf8 ("Gate & arpeggiator"), utf8 (
            ...
            "semitones (later terms folded mod 24 to stay in register), cycling over 5/8/13\n"
            "steps. Combine with the gate for golden rhythm on top of golden melody —\n"
    ...
    s.push_back ({ utf8 ("Gate i arpeggiator"), utf8 (
        ...
        "(dalsze wyrazy składane mod 24, żeby nie uciec z rejestru), w cyklu 5/8/13\n"
        "kroków. W parze z gate'em: złoty rytm na złotej melodii — oba patterny\n"
